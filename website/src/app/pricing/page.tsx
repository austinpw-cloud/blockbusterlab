            ...
            {[
              {
                ...
                a: "가능합니다. 다만 이 경우 원본 스크린샷 5장 이상과 게임 로고를 직접 업로드해 주셔야 합니다. 이미 출시된 게임은 Google Play URL만 있으면 자동으로 자료를 수집합니다.",
              },
              {
                q: "작업 기간은 얼마나 걸리나요?",
                a: "ASO 서비스는 접수일 기준 5영업일 내 결과물을 전달합니다. 납기일은 접수 시 자동으로 계산되어 주문 확인 메일에 안내됩니다.",
              },
              {
              ...
              {
                q: "iOS ASO는 언제 가능해지나요?",
                a: "현재 Google Play만 지원합니다. App Store 지원은 다음 단계(Phase 1.5)에서 오픈 예정입니다. 오픈 시 이메일로 안내드립니다.",
              },
              {
                q: "결제는 어떻게 하나요?",
                a: "초기에는 무통장 입금으로 진행합니다. 신청 접수 후 담당자가 결제 안내를 이메일로 보내드립니다. 세금계산서 발행 가능합니다.",
              },
            ].map((faq) => (
              <div
                key={faq.q}
